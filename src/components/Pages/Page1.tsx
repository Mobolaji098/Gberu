...
export default function Page1() {
  ...
  return (
    <div className={`flex flex-col min-h-screen  bg-white dark:bg-black lg:min-w-[1281px] overflow-hidden px-12 py-10 relative lg:pb-[20rem] md:min-w-[780px] min-w-[580px]`}>
